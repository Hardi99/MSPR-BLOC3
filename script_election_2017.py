...
df = pd.read_excel("base\\PR17_BVot_T1_FE.xlsx")
...
orientations_politiques = {
    "ARTHAUD": "Gauche", "ASSELINEAU": "Droite", "LASSALLE": "Gauche", 
    "MÉLENCHON": "Gauche", "POUTOU": "Gauche", "CHEMINADE": "Gauche",
    "DUPONT-AIGNAN": "Droite", "LE PEN": "Droite",
    "FILLON": "Droite", "HAMON": "Gauche", "MACRON": "Milieu"
}

# Supposons que les colonnes Voix et Nom sont formatées comme Voix.i et Nom.i où i est un index de candidat
num_candidats = 11  # Semble être 12 candidats basés sur les colonnes Nom.0 à Nom.11
...
print(df_final)
df_final.to_excel('filtre\\resultats_2017.xlsx', index=False)
